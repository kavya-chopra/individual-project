...
# If the first getaddrinfo call of this request's life is on a thread,
...
class SocketInfo(object):
    ...
    def _close_socket(self):
        ...
        # Note: We catch exceptions to avoid spurious errors on request
        # shutdown.
        try:
            self.sock.close()
        except Exception:
    ...
    def _raise_connection_failure(self, error):
        ...
        # first. Eventually in PyEval_EvalFrameEx the request checks for
...
def _create_connection(address, options):
    ...
    if err is not None:
        ...
        # host with an OS/kernel or Python request that doesn't
